      ...
      <div className="container-fluid ">
        <div className="row hidden lg:flex lg:items-center lg:justify-between p-3 text-white bg-gradient-to-br from-indigo-800 to-gray-800">
          <div className="col-6 d-flex items-center">
            <h5 className="fw-bold ">চট্টগ্রাম মডেল কেয়ার স্কুল এন্ড কলেজ</h5>
          </div>
        </div>
          ...
          <div className="">
            {/* <span className="navbar-brand flex items-center">
              ...
              <div className=" flex-col justify-center hidden lg:flex">
                <span className="font-bold ">চট্টগ্রাম মডেল কেয়ার স্কুল এন্ড কলেজ</span>
                <span className="small text-gray-500">কুঞ্জছায়া, চট্টগ্রাম</span>
              </div>
              <span className="lg:hidden block text-sm">
                চট্টগ্রাম মডেল কেয়ার স্কুল এন্ড কলেজ
              </span>
            </span> */}

            <div className="flex w-full shadow-md" id="navbarNav">
              <ul className="navbar-nav hidden lg:flex lg:items-center lg:justify-center  lg:w-full">
